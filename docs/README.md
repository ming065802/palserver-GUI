...
| [PLAN_DISCORD_BOT.md](./PLAN_DISCORD_BOT.md) | **Discord Bot 整合計畫**：獨立 `discord-bot/`（Node.js）、GUI spawn、Management API 觸發（**Phase 1–2 已實作**） |
...
3. v1.4.1 為 Tier 2 首個二進位發布；遠端實例可使用線上地圖、世界設定唯讀與手動解封，本機專用功能仍依 `isRemote` 隱藏。
