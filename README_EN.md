...
- **Palworld 1.0 support** (in development): crossplay settings, voice chat, REST API admin, auto-restart, and 1.0 world parameters.
...
The project is actively maintained. For Palworld 1.0 dedicated servers, follow [GitHub Releases](https://github.com/Dalufishe/palserver-GUI/releases) and [CHANGELOG.md](/CHANGELOG.md). Please report issues on [issues](https://github.com/Dalufishe/palserver-GUI/issues).
