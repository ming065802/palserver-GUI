...
const zh_tw = {
  ...
  CreateRemoteServerDesc:
    '連線至已在 VPS 或遠端主機上運行的 Palworld 1.0 專服。請確認遠端已啟用 REST API，且 8212 埠可從本機連線。',
  RemoteServerBadge: '遠端',
  RemoteEndpoint: '遠端位址',
  ...
  RemoteWorldSettingsReadOnly:
    '遠端世界設定為唯讀，資料來自伺服器 REST API。若要修改，請於遠端主機編輯 PalWorldSettings.ini 並重啟伺服器。',
  RemoteWorldSettingsReadOnlyShort: '世界設定（唯讀）',
  RemoteWorldSettingsFetchFailed:
    '無法從遠端伺服器取得設定。請確認 REST API 可連線後再按重新整理。',
  RemoteWorldSettingsUnknownKeys:
    '部分 REST 回傳欄位未對應到 GUI 分頁，請切換至 JSON 檢視查看完整內容。',
  WorldSettingsJsonView: 'JSON 檢視',
  WorldSettingsGuiView: 'GUI 檢視',
  Refresh: '重新整理',
  TestConnection: '測試連線',
  TestingConnection: '測試中…',
  RemoteConnectionSuccess: '連線成功，可以建立遠端連接。',
  RemoteConnectionInvalidHost: '請輸入遠端主機 IP 或域名。',
  RemoteConnectionAuthFailed: 'Admin 密碼錯誤，請確認遠端伺服器設定。',
  RemoteConnectionFailed: '無法連線至遠端 REST API，請檢查防火牆、埠轉發與主機位址。',
  RemoteConnectionRestDisabled: '遠端伺服器未啟用 REST API 或端點無法存取。',
  RemoteConnectionTestRequired: '建立前請先按「測試連線」並確認成功。',
  ...
  RCONEnabledDesc:
    '啟用遠端控制 RCON（已棄用）。建議優先使用 REST API；RCON 仍可用於 Palguard 進階指令。',
  RESTAPIEnabledDesc:
    '啟用 REST API（Palworld 1.0 官方推薦的管理方式）。玩家列表、踢人、封禁與定時重啟皆依賴此功能。',
  ...
  bPalLost: '死亡永久丟失帕魯',
  bEnableVoiceChat: '啟用近距離語音聊天',
  VoiceChatMaxVolumeDistance: '語音全音量距離（公分）',
  VoiceChatZeroVolumeDistance: '語音靜音距離（公分）',
  MonsterFarmActionSpeedRate: '牧場產出速度倍率',
  AutoTransferMasterThresholdDays: '公會會長移交：不活躍天數',
  AutoTransferMasterCheckIntervalSeconds: '公會會長移交：檢查間隔（秒）',
  ...
  bDisplayPvPItemNumOnWorldMap_BaseCamp: '地圖顯示據點 PvP 物品數',
  bDisplayPvPItemNumOnWorldMap_Player: '地圖顯示玩家 PvP 物品數',
  ItemWeightRate: '物品重量倍率',
  ItemCorruptionMultiplier: '物品腐敗速度倍率',
  ChatPostLimitPerMinute: '每分鐘聊天訊息上限',
  bAllowClientMod: '允許客戶端 Mod 加入',
  bIsShowJoinLeftMessage: '顯示玩家進出訊息',
  bUseAuth: '啟用 Steam 身分驗證',
  Difficulty_None: '無（自訂）',
  Difficulty_Easy: '簡單',
