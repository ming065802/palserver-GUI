...
const en = {
  ...
  // 20240218
  RCONEnabledDesc:
    'Enable Remote Console (RCON, deprecated). Prefer REST API; RCON is still needed for some Palguard commands.',
  ...
  RESTAPIEnabledDesc:
    'Enable REST API (recommended admin interface for Palworld 1.0). Player list, kick/ban, and scheduled restarts rely on this.',
  ...
  AutoRestartDesc:
    'Restart the server periodically. Requires REST API (or RCON). Recommended every 6–12 hours for Palworld 1.0.',
  ScheduledStop: 'Scheduled Stop',
  ScheduledStopDesc:
    'Gracefully shut down the server daily at a set time (save then shutdown). Requires REST API (or RCON).',
  ScheduledStopRemoteDesc:
    'Gracefully shut down the remote server daily via REST API.',
  ScheduledStart: 'Scheduled Start',
  ScheduledStartDesc:
    'Automatically start the local server daily at a set time. Only works while palserver GUI is running.',
  ScheduledRestart: 'Scheduled Restart',
  ScheduledRestartDesc:
    'Shut down and restart the local server daily at a set time. Requires REST API (or RCON).',
  ScheduledRestartRemoteDesc:
    'Shut down the remote server daily via REST API. The GUI cannot auto-start remote servers.',
  ScheduleWarningMinutes: 'Countdown before shutdown (minutes)',
  ScheduleRequiresGuiOpen:
    'Schedules only run while palserver GUI is open. Closing the GUI stops all scheduled tasks.',
  ScheduleRequiresRestApi:
    'Scheduled stop and restart require REST API (recommended) or RCON, plus an admin password in server settings.',
  CrashRestart: 'Crash Restart',
  CrashRestartDesc:
    'Restart the server when it crashes. Requires REST API (or RCON).',
  ...
  bEnableVoiceChat: 'Enable Proximity Voice Chat',
  VoiceChatMaxVolumeDistance: 'Voice Full-Volume Distance (cm)',
  VoiceChatZeroVolumeDistance: 'Voice Silence Distance (cm)',
  MonsterFarmActionSpeedRate: 'Ranch Production Speed Rate',
  AutoTransferMasterThresholdDays: 'Guild Master Transfer: Inactive Days',
  AutoTransferMasterCheckIntervalSeconds:
    'Guild Master Transfer: Check Interval (seconds)',
  bAdditionalDropItemWhenPlayerKillingInPvPMode: 'Extra PvP Kill Drops',
  AdditionalDropItemWhenPlayerKillingInPvPMode: 'PvP Kill Drop Type',
  AdditionalDropItemWhenPlayerKillingInPvPMode_None: 'None',
  AdditionalDropItemWhenPlayerKillingInPvPMode_PlayerDropItem: 'Player Items',
  AdditionalDropItemWhenPlayerKillingInPvPMode_PlayerDropInventory: 'Inventory',
  AdditionalDropItemNumWhenPlayerKillingInPvPMode: 'PvP Kill Drop Count',
  bDisplayPvPItemNumOnWorldMap_BaseCamp: 'Show Base Camp PvP Items on Map',
  bDisplayPvPItemNumOnWorldMap_Player: 'Show Player PvP Items on Map',
  ItemWeightRate: 'Item Weight Rate',
  ItemCorruptionMultiplier: 'Item Corruption Multiplier',
  ChatPostLimitPerMinute: 'Chat Messages Per Minute Limit',
  bAllowClientMod: 'Allow Client Mods',
  bIsShowJoinLeftMessage: 'Show Join/Leave Messages',
  bUseAuth: 'Require Steam Authentication',
  Difficulty_None: 'None (Custom)',
